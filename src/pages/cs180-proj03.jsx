          ...
          <div className="section-item">
            ...
            <div className="section-content">
              ...
              <div className="results-box">
                ...
                <ul>
                  <li><strong>Method:</strong> Direct Linear Transform (DLT) using least squares</li>
                  <li><strong>Solver:</strong> <code>numpy.linalg.lstsq</code> (SVD-based, numerically stable)</li>
                  <li><strong>Correspondences:</strong> 8+ manually selected point pairs per image pair</li>
                  <li><strong>Scale Fixing:</strong> Set <InlineMath math={"h_9 = 1"} /> to fix projective scale</li>
                </ul>
              </div>
              ...
              <div className="results-box">
                ...
                <p>For each image pair with 8 correspondences:</p>
                <ul>
                  <li><strong>System dimensions:</strong> <InlineMath math={"A \\in \\mathbb{R}^{16 \\times 8}"} />, <InlineMath math={"\\mathbf{b} \\in \\mathbb{R}^{16}"} /></li>
                  <li><strong>Solution method:</strong> Least squares via SVD decomposition</li>
                  <li><strong>Numerical stability:</strong> SVD-based approach avoids ill-conditioned normal equations</li>
                  <li><strong>Scale normalization:</strong> Fixed <InlineMath math={"h_9 = 1"} /> to eliminate projective ambiguity</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="section-item">
            ...
            <div className="section-content">
              ...
              <div className="results-box">
                ...
                <p>Successfully rectified both wrap images with:</p>
                <ul>
                  <li><strong>Method:</strong> Bilinear interpolation for smooth results</li>
                  <li><strong>Output mode:</strong> Same size as original images</li>
                  <li><strong>Quality:</strong> High-resolution rectified outputs</li>
                </ul>
              </div>
          ...
          <div className="section-item">
            ...
            <div className="section-content">
              ...
              <div className="subsection">
                ...
                <ol>
                  <li>Building Laplacian pyramids of each warped image (difference between Gaussian levels)</li>
                  <li>Building Gaussian pyramids of each warped alpha mask</li>
                  <li>Blending at each level using weighted averaging with the level's Gaussian masks</li>
                  <li>Reconstructing the final mosaic by collapsing the blended Laplacian pyramid</li>
                </ol>
                <p>
              ...
              <div className="results-box">
                ...
                <p>Successfully created mosaics using both methods:</p>
                <ul>
                  <li><strong>Weighted Averaging:</strong> Simple, fast, good default for most scenes</li>
                  <li><strong>Laplacian Pyramid:</strong> Better edge continuity, reduced ghosting artifacts</li>
                  <li><strong>Seam Quality:</strong> Laplacian method produced noticeably smoother transitions</li>
                  <li><strong>Performance:</strong> 4-level pyramid provided excellent results with reasonable computation</li>
                </ul>
              </div>
